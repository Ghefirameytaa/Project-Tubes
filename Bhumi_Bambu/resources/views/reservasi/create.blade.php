...
<div class="res-page">
  ...
  <section class="res-form-section">
    <div class="res-container">
      ...
      {{-- PERBAIKAN: Tambahkan Error & Success Messages --}}
      @if(session('error'))
          ...
          <div class="res-form-grid">
            ...
            <div class="res-form-group full-width">
              ...
              <div class="res-input-wrapper">
                ...
                <input type="text" name="nama_lengkap" class="res-input with-icon @error('nama_lengkap') error @enderror" 
            ...
            <div class="res-form-group full-width">
              ...
              <div class="res-phone-wrapper">
                ...
                <input type="tel" name="nomor_ponsel" class="res-input with-prefix @error('nomor_ponsel') error @enderror" 
            ...
            <div class="res-form-group full-width">
              ...
              <input type="email" name="email" class="res-input @error('email') error @enderror" 
            ...
            <div class="res-form-group">
              ...
              <input type="number" name="jumlah_orang" class="res-input @error('jumlah_orang') error @enderror" 
                     min="1" value="{{ old('jumlah_orang', 1) }}" 
                     placeholder="untuk perjalanan" required>
              @error('jumlah_orang')
                <span class="error-text">{{ $message }}</span>
              @enderror
            ...
            <div class="res-form-group">
              ...
              <div class="res-input-wrapper">
                ...
                <input type="time" name="jam_acara" class="res-input with-icon @error('jam_acara') error @enderror" 
                       value="{{ old('jam_acara') }}" required>
              </div>
              @error('jam_acara')
                <span class="error-text">{{ $message }}</span>
              @enderror
            ...
            <div class="res-form-group full-width">
              ...
              <input type="date" name="tanggal_reservasi" class="res-input @error('tanggal_reservasi') error @enderror" 
            ...
            <div class="res-form-group full-width">
              ...
              <textarea name="catatan" class="res-textarea" rows="4" placeholder="Contoh: minta lokasi dekat toilet / permintaan khusus lainnya">{{ old('catatan') }}</textarea>
              @error('catatan')
                <span class="error-text">{{ $message }}</span>
              @enderror
            </div>
...
<style>
  ...
  * {
  ...
  .res-textarea:focus {
    border-color: var(--orange);
    box-shadow: 0 0 0 3px rgba(246, 160, 26, 0.1);
  }

  /* PERBAIKAN: Error state */
  .res-input.error,
  .res-textarea.error {
    border-color: var(--red);
  }

  .res-input.error:focus,
  .res-textarea.error:focus {
    border-color: var(--red);
