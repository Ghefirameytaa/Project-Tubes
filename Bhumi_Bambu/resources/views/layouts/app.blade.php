...
<head>
  ...
  <style>
    ...
    .sidebar{ width:280px; background:#fff; border-right:1px solid #e8eaed; padding:18px 16px; }
    .brand{ display:flex; align-items:center; gap:12px; padding:8px 10px 18px; border-bottom:1px solid #f0f1f2; margin-bottom:14px; }
    .brand .logo{
      width:52px; height:52px; border-radius:14px; border:1px solid #e9ecef;
      display:flex; align-items:center; justify-content:center;
      font-weight:900; color:var(--brand); background:#fff;
    }

    .menu a{
      display:flex; align-items:center; gap:12px;
      padding:12px 14px; border-radius:14px;
      text-decoration:none; color:#1f2937; font-weight:800;
      margin-bottom:10px;
    }
    ...
    .searchbar{
      flex:1; background:#fff; border-radius:999px; padding:10px 14px;
    ...
    .table thead th{ background:#f3f6f7 !important; color:#111827; border-bottom:0; }
    .table td, .table th{ padding:16px 14px; }

    .status-pill{
      border-radius:999px; padding:8px 12px; font-weight:900; font-size:12px;
      display:inline-block; color:#fff; border:0;
    }
...
<div class="app-shell">
  <aside class="sidebar">
    <div class="brand">
      ...
      <div>
        <div style="font-weight:900; line-height:1;">BHUMI BAMBU</div>
        <small class="text-muted">BATURRADEN</small>
      </div>
    </div>
